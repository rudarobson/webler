...
Document.prototype.visit = function(enter, exit, level) {
  ...
  if (level == undefined)
    domutils.visitNode(this, enter, exit);
  else
    domutils.visitNodeWithLevel(this, enter, exit, level);
}
...
Element.prototype.visit = function(enter, exit, level) {
  if (typeof(exit) == typeof(0)) {
    level = exit;
    exit = undefined;
  }
